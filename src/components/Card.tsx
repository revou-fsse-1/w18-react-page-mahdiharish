...
<div className="relative w-[200px] h-[270px] rounded-xl overflow-hidden bg-black hover:scale-105 transition-transform">
  <button className={`${isLiked ? 'bg-green-500 text-white' : 'bg-white text-black'} text-white absolute top-2 right-2 z-10 px-2 py-1 rounded-full`} type="button" onClick={toggleLike}>
